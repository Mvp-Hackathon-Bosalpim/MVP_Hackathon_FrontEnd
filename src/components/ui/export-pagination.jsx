...
export default function Pagination({
  ...
  const goToPrevSet = () =>
    hasPrevSet && onPageChange(setStart - PAGE_SET_SIZE);
  const goToNextSet = () =>
    hasNextSet && onPageChange(setStart + PAGE_SET_SIZE);
    ...
    <div className="grid w-full grid-cols-3 items-center px-4 py-4">
      ...
      <div className="flex justify-end">
        <select
          ...
          className="cursor-pointer rounded border border-gray-200 px-2 py-1 text-sm text-gray-500 focus:outline-none"
        >
